...
class ResConfigSettings(models.TransientModel):
    ...
    matricule_by_company = fields.Boolean("Par société", related="company_id.matricule_by_company", readonly=False)
    ...
    use_parent_categories_to_determine_prefix = fields.Boolean(string='Use parent categories to determine the prefix',
                                                               required=False, readonly=False, index=False, store=True)
    """***********************Settings***********************"""
