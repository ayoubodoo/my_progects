...
class kzm_daily_attendance(models.Model):
    ...
    state = fields.Selection(string=_("State"), selection=[('draft', 'Nouveau'), ('done', 'Terminé'), ], required=False,
                             default='draft')
    exception = fields.Text(translate=True,string=_("Erreur de pointage"), required=False, readonly=True)
    ...
    kzm_sous_ferme_id = fields.Many2one(comodel_name="sub.farm", string=_("Sous Ferme de paie"), )
