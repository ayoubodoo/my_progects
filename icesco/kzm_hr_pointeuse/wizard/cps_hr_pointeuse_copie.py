...
class kzm_hr_pointeuse_copie(models.Model):
    ...
    resultat = fields.Text(translate=True,string=_("Résultat"), required=False, )
    taux = fields.Float(translate=True,string=_("Taux"), required=False, )
    ...
    def copie_pointeuse(self):
        ...
        # TODO à voir (l'érreur sur copie de poiteuse')
