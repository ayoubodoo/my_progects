...
class CpsBadge(models.Model):
    ...
    def create(self, vals):
        ...
        :return:
        """
        new_record = super(CpsBadge, self.with_context(ignorecode=True)).create(vals)
    ...
    def write(self, vals):
        ...
        res = super(CpsBadge, self).write(vals)
    ...
    def unlink(self):
        ...
        res = super(CpsBadge, self).unlink()
        return res



    def force_unlink(self):
        return super(CpsBadge, self).unlink()
