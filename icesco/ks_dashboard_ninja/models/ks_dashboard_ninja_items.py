...
class KsDashboardNinjaItems(models.Model):
    ...
    dh_ks_background_color = fields.Char(string="Background icon Color",
                                      default="#ffffff,0.99", help=' Select the background color with transparency. ')
    ...
    ks_target_value = fields.Boolean(string="Enable Value Target", help='Show the values target.', default=True)
    ks_count_value = fields.Boolean(string="Enable Value Count", help='Show the values count.', default=True)
    ks_result_value = fields.Boolean(string="Enable Value Result", help='Show the values result.', default=True)
    ...
    ks_data_label_type = fields.Selection([('percent', 'Percent'), ('value', 'Value')], string='Show Data Value Type',
                                          ...
                                          default='percent')
    symbol = fields.Char(string='Symbol', store=True)

    data_symbol = fields.Char(string='Data Symbol', store=True)
    ...
    @api.depends('ks_chart_measure_field', 'ks_chart_cumulative_field', 'ks_chart_relation_groupby',
                 ...
                 'ks_record_data_limit', 'ks_chart_data_count_type', 'ks_chart_measure_field_2', 'ks_goal_enable', 'ks_target_value','ks_count_value','ks_result_value',
    ...
    @api.depends('ks_domain', 'ks_dashboard_item_type', 'ks_pagination_limit', 'ks_model_id', 'ks_sort_by_field',
                 ...
                 'ks_goal_enable', 'ks_target_value','ks_count_value', 'ks_result_value','ks_standard_goal_value', 'ks_goal_lines', 'ks_domain_extension')
