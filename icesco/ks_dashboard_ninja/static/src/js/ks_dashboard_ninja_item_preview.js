odoo.define('ks_dashboard_ninja_list.ks_dashboard_item_preview', function(require) {
    ...
    var KsItemPreview = AbstractField.extend({
        ...
        ksNumFormatter: function(num, symbol, digits) {
            var negative;
            var si = [{
                    value: 1,
                    symbol: ""
        ...
        ksNumColombianFormatter: function(num, symbol, digits, ks_precision_digits) {
            var negative;
            var si = [{
                    value: 1,
                    symbol: ""
...
//        Indian format shorthand function
        ksNumIndianFormatter: function(num, symbol, digits) {
            var negative;
            var si = [{
                value: 1,
                symbol: ""
        ...
        _render: function() {
            ...
            var $val;
            var item_info;
            var ks_rgba_background_color, ks_rgba_font_color, ks_rgba_icon_color, dh_ks_rgba_background_color;
            self.$el.empty();
            ks_rgba_background_color = self._get_rgba_format(field.ks_background_color)
            dh_ks_rgba_background_color = self._get_rgba_format(field.dh_ks_background_color)
            ...
            item_info = {
                ...
                count: self.ksNumFormatter(field.ks_record_count, field.symbol, 1),
            ...
            if (field.ks_multiplier_active){
                ...
                item_info['count'] = self._onKsGlobalFormatter(ks_record_count, field.symbol, field.ks_data_format, field.ks_precision_digits);
                item_info['count_tooltip'] = ks_record_count;
            }else{
                item_info['count'] = self._onKsGlobalFormatter(field.ks_record_count, field.symbol, field.ks_data_format, field.ks_precision_digits);
            }
...
//            count_tooltip
            ...
            switch (field.ks_layout) {
                ...
                case 'layout2':
                    ...
                    $val.find('.ks_dashboard_icon_l2').css({
                        "background-color": dh_ks_rgba_background_color,
                    });
                    $val.css({
                        "background-color": ks_rgba_background_color,
                        "color": ks_rgba_font_color
        ...
        _onKsGlobalFormatter: function(ks_record_count, ks_symbol, ks_data_format, ks_precision_digits){
            var self = this;
...
//                return ks_record_count;
                ...
                if (ks_data_format == 'indian'){
                    return self.ksNumIndianFormatter( ks_record_count, ks_symbol , 1);
                }else if (ks_data_format == 'colombian'){
                    return self.ksNumColombianFormatter( ks_record_count, ks_symbol , 1, ks_precision_digits);
                }else{
                    return self.ksNumFormatter(ks_record_count, ks_symbol, 1);
                }
            }
        },
