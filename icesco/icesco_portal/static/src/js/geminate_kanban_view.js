odoo.define('website_goal_kanbanview.kanban_view', function (require) {
	"use strict";
...
// 			$('.o_portal_my_doc_table').hide()
		...
		if (window.location.href.indexOf('/my/goal') > -1) {
// 			$('.o_portal_my_doc_table').hide()
			var list_button = $(".goal_list");
			var kanban_button = $(".kanban_goal");
			var doc_quote_table = $('.o_portal_my_doc_table');
			var kanban_view = $(".kanban_view_goal");
			kanban_button.css("background", "black");
			kanban_view.show();
			doc_quote_table.hide()
